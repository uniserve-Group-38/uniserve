...
export default async function ServicesPage({
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6] py-12 pb-28 md:pb-12">
      <div className="container max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex flex-col gap-6 mb-12">
          <div className="flex flex-col gap-4">
            <h1 className="inline-block">
              <span className="bg-yellow-400 border-4 border-black px-6 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] inline-block text-4xl sm:text-6xl font-black tracking-tighter -rotate-1">
                SERVICES
              </span>
            </h1>
